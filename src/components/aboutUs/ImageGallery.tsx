    ...
    media: [
      {
        ...
        title: "City at Night",
        content:
          "https://i.postimg.cc/MTSXJLSd/city-at-night-1-1527139-639x426.jpg",
      },
      {
        type: "video" as const,
        title: "Urban Motion",
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        title: "Night Skyline",
        content:
          "https://i.postimg.cc/4xjmBdFC/night-skyline-1225750-640x480.jpg",
      },
      {
        type: "video" as const,
        title: "City View",
  ...
  },
  {
    ...
    media: [
      ...
      },
      {
        ...
        title: "Downtown",
        content:
          "https://i.postimg.cc/wBJ3PpS1/city-at-night-2-1516046-640x480.jpg",
      },
      {
        type: "image" as const,
        title: "City Glow",
...
const GallerySection: React.FC<GallerySectionProps> = ({
  ...
  }, [media.length, sectionIndex, selectImage]);
            ...
            (item.type === "image" || item.type === "video") ? (
              ...
              <>
                ...
                <div
                  ...
                  role="button"
                  aria-label={
                    playingVideo === item.id ? "Stop video" : "Play video"
                  }
                >
