...
const Coverflow3D: React.FC = () => {
    ...
    const imageData: ImageData[] = [
        ...
        {
            src: '/images/cascading-waterfall.jpg',
            alt: 'Waterfall',
            title: 'Waterfall',
                        ...
                        {imageData.map((_, index) => (
                            <Box
                                ...
                                sx={{
                                    ...
                                    boxShadow: index === currentIndex ? '0 0 10px rgba(0, 255, 255, 0.6)' : 'none',
                                    '&:hover': {
