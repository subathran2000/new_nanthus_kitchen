...
const SpiralBackground: React.FC<SpiralBackgroundProps> = ({ activeCategory = "Starters" }) => {
  ...
  // Force Spiral view for consistency as requested
  const isSpiral = true;
              ...
              <Box key={idx} sx={{ mb: 6 }}>
                ...
                <List sx={{ p: 0, display: 'flex', flexDirection: 'column', gap: 2 }}>
                  {sub.items.map((item) => (
                    ...
                    >
                      <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, width: '100%', alignItems: { xs: 'stretch', md: 'center' }, position: 'relative', zIndex: 2 }}>
                        {/* Image Section */}
                        <Box
                        ...
                        <Box sx={{ flex: 1, px: { xs: 2, md: 2 }, py: 2, minWidth: 0 }}>
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 0.5, flexDirection: { xs: 'column', md: 'row' }, gap: { xs: 1, md: 0 } }}>
                            <Typography sx={{
                              color: '#fff',
                              fontWeight: 700,
                        ...
                        <Box sx={{ pr: 2, display: { xs: 'none', md: 'flex' }, alignItems: 'center', flexShrink: 0 }}>
                          <Box
                            className="price-pill"
                            sx={{
                              bgcolor: 'transparent',
