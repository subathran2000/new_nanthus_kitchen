                ...
                <Box sx={{ mt: 10, display: 'flex', flexDirection: { xs: 'column', md: 'row' }, justifyContent: 'space-between', alignItems: 'center', gap: 4 }}>
                    <Box sx={{ textAlign: { xs: 'center', md: 'left' } }}>
                        <Typography variant="h5" sx={{ fontWeight: 800, color: '#fff', mb: 1, letterSpacing: '2px' }}>
                            NEW NANTHU'S <span style={{ color: '#00ffff' }}>KITCHEN</span>
                        </Typography>
                        <Typography variant="body2" sx={{ color: '#aaccff', opacity: 0.6 }}>
                            © 2026 New Nanthu's Kitchen. Crafted with passion & spice.
                        </Typography>
                        <Typography variant="caption" sx={{ color: '#aaccff', opacity: 0.4, mt: 1, display: 'block', letterSpacing: '0.05em' }}>
                            Created by <a href="https://www.akvisionsystems.com" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none', borderBottom: '1px solid rgba(170, 204, 255, 0.3)' }}>AK Vision Systems</a>
                        </Typography>
                    </Box>
