...
const CateringForm = ({ isPopup = false }: { isPopup?: boolean }) => {
    ...
    /* 🌿 Elegant Input Style (Consistent with ContactForm) */
    const inputStyle = {
        ...
        // Specific style for Select component to match
        '& .MuiSelect-select': {
            padding: '8px 14px',
            color: '#fff',
            display: 'flex',
                        ...
                        {!submitted ? (
                            ...
                            >
                                <Box textAlign="center" mb={3}>
                                    ...
                                    >
                                        <span style={{ color: '#00ffff' }}>Catering</span> Inquiry
                                    </Typography>
                                    <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.5)', letterSpacing: '0.1em' }}>
                                ...
                                <Grid container spacing={1.5}>
                                    ...
                                    <Grid item xs={12} md={6}>
                                        ...
                                        >
                                            ...
                                            <MenuItem value="Private">Private Dinner</MenuItem>
                            ...
                            <Box textAlign="center" py={10}>
                                ...
                                <Typography sx={{ color: '#aaccff', mt: 2 }}>
                                    We'll contact you shortly to plan your event.
                                </Typography>
                            </Box>
                        )}
                    </AnimatePresence>
